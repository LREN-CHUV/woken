...
object MiningQueries {
  ...
  def miningQuery2Job(
    ...
    val jobId :: featuresDb :: featuresTable :: metadata :: HNil = prepareQuery(variablesMetaService, jobsConfiguration, query)
  ...
  private def prepareQuery(variablesMetaService: VariablesMetaService,
                           jobsConfiguration: JobsConfiguration,
                           query: Query): String :: String :: String :: Validation[JsObject] :: HNil = {
